...
@endphp
 <!--============Scroll 03 start==============-->
	...
	<div class="custom-page">
		<div class="container">
			<h1 class="custom-page-title text-center text-white">About Us</h1>
			<h6 class="custom-page-subtitle text-center"></h6>
			<div class="slug-description">
				<h5 class="career-text-title"><font style="color="#d6a5bd"><a href="{{ URL::to('/institute') }}" target="_blank">{{ $seo->meta_title }} </a></font><span style="background-color: rgb(0, 0, 0);"><br></span></h5><p></p>

<p style="text-align:justify">{!! $setting->institute_info_long ??'' !!}</p>
