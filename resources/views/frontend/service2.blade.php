...
@section('meta')
  <title>Business Development Program</title>
@endsection
@section('content')
@php
...
@endphp
 <!--============Scroll 03 start==============-->
	...
	<div class="custom-page">
		<div class="container">
			<h1 class="custom-page-title text-center text-white">{{ $seo->service2_tittle ??'' }}</h1>
			<h6 class="custom-page-subtitle text-center"></h6>
			<div class="slug-description">
				<h5 class="career-text-title"><font style="color="#d6a5bd"><a href="{{ URL::to('/institute') }}" target="_blank">{{ $seo->service2_tittle ??'' }}: </a></font><span style="background-color: rgb(0, 0, 0);"><br></span></h5><p></p>

<p style="text-align:justify">{!! $seo->service2_text ??'' !!}</p>
