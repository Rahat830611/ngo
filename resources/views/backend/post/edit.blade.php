                  ...
                  <div class="col-lg-6">
                  	  <label for="exampleInputFile">Old Image</label><br>
                  		...
                  		<input type="hidden" name="oldimage" value="{{ $post->image }}">
			                    ...
			                    <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">Short Description (Maximum 60 Words)</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="tags_en" value="{{ $post->tags_en }}">
                  </div>
               </div>
